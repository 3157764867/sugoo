...
=======
<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\marketing\marketing.html";i:1515632560;}*/ ?>
>>>>>>> lzk
...
=======
<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\marketing\marketing.html";i:1515632454;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>品牌列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('index/marketing/add'); ?>" class="actionBtn add">添加品牌</a>品牌列表</h3>
    <div class="filter">
    <form action="product.php" method="post">
     <select name="cat_id">
      <option value="0">未分类</option>
