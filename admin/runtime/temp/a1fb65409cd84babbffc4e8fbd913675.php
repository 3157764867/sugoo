<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\image\image.html";i:1515586423;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>图片列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('index/goods/index'); ?>" class="actionBtn add">商品列表</a>图片列表</h3>
    <div class="filter">
    </div>
        <div id="list">
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        <th align="80">图片类型名称</th>
      ...
      <?php foreach($arr as $k => $v): ?>
        ...
        <td align="center">商品logo</td>
        <?php endif;if($v['photo_type'] == 1):?>
        <td align="center">商品轮播图</td>
        <?php endif;if($v['photo_type'] == 2):?>
        <td align="center">商品详情图</td>
        <?php endif;?>
        <td align="center"><img src="<?php echo $v['photo_url']; ?>" width="200px" height="200px"></td>
        <td align="center">
           <a href="delete?id=<?php echo $v['photo_id']; ?>">删除</a>
        </td>
      </tr>
      <?php endforeach; ?>
    </table>
