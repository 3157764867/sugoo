<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\attr\addattr.html";i:1514979020;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加属性</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo url('index/attr/index'); ?>" class="actionBtn">属性列表</a>属性</h3>
    <form action="<?php echo url('attr/attrAdd'); ?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">属性名称</td>
       <td>
        <input type="text" name="attr_name" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
