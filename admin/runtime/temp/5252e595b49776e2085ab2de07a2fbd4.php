<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\attrvalue\attrvalue_set.html";i:1514978955;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加属性</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo url('index/attrvalue/index'); ?>" class="actionBtn">属性值列表</a>属性值</h3>
    <form action="<?php echo url('attrvalue/valueSave'); ?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">属性值名称</td>
       <td>
        <input type="text" name="attra_val" value="<?php echo $res['attra_val']; ?>" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
        ...
        <select name="attr_id">
         <option value="0">请选择属性</option>
          <?php foreach($arr as $k =>$v): ?>
              <option value="<?php echo $v['attr_id']; ?>"><?php echo $v['attr_name']; ?></option>
          <?php endforeach; ?>
        </select>
       </td>
      </tr>
      <tr>
       <td></td>
       <td>
        <input type="hidden" name="id" value="<?php echo $res['av_id']; ?>">
