<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\money\money.html";i:1515475022;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>资金管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <!-- <h3><a href="<?php echo url('index/money/add'); ?>" class="actionBtn add">添加品牌</a>品牌列表</h3> -->
    <div class="filter">
  ...
  <!--   <span>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th align="left">资金</th>
        <th width="300" align="center">资金来源</th>
      ...
      <?php foreach($data as $k=>$v): ?>
        ...
        <td><a href="product.php?rec=edit&id=15"><?php echo $v['money']; ?></a></td>
        <td align="center"><a href="product.php?cat_id=3"><?php echo $v['from']; ?></a></td>
