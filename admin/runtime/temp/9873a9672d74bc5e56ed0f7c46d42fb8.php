<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\category\product_category.html";i:1514961285;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>商品分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('index/category/add'); ?>" class="actionBtn add">添加分类</a>商品分类</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     ...
     <?php foreach($res as $k => $v): ?>
      <tr>
        ...
        <td align="center"><a href="update?id=<?php echo $v['c_id']; ?>">编辑</a> | <a href="delete?id=<?php echo $v['c_id']; ?>">删除</a></td>
     </tr>
     <?php endforeach; ?>
    </table>
           </div>
