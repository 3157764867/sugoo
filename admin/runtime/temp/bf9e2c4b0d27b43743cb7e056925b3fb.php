<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\pay\addpay.html";i:1515028400;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加支付方式</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo url('index/pay/index'); ?>" class="actionBtn">支付方式列表</a>添加支付方式</h3>
    <form action="<?php echo url('index/pay/do_add'); ?>" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">支付方式</td>
       <td>
        <input type="text" name="pay_name" id="pay_name" size="80" class="inpMain" />
      ...
      <tr>
       ...
       <td>
         <input type="file" name="img"  size="80">
       </td>
      </tr>
