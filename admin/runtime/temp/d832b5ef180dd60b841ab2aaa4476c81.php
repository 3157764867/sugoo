<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\pay\pay.html";i:1515148177;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>支付方式列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <?php foreach($data as $k=>$v): ?>
        ...
        <td align="center"><img src="/sugoo/admin/public//uploads/<?php echo $v['pay_logo']; ?>" width="80"></td>
        <td align="center"><?php echo $v['addtime']; ?></td>
        <td align="center">
                    <?php if($v['status'] == 1): ?>
                     <a href="javascript:void(0)"  id="dis" data-id="<?php echo $v['id']; ?>" data-st="<?php echo $v['status']; ?>" class="btn"> 禁用</a> 
                    <?php else: ?>
                       <a href="javascript:void(0)" style="background: #ccc;" id="dis" data-id="<?php echo $v['id']; ?>" data-st="<?php echo $v['status']; ?>" class="btn">启用</a> 
                    <?php endif; ?>
                 </td>
      </tr>
      <?php endforeach; ?>
