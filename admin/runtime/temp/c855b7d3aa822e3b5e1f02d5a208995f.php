<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\brand\brand_set.html";i:1515586580;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加品牌</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="<?php echo url('brand/brandSave'); ?>" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">品牌名称</td>
       <td>
        <input type="text" name="b_name" value="<?php echo $arr['b_name']; ?>" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
       ...
       <td>
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="b_desc" style="width:780px;height:400px;" class="textArea"><?php echo $arr['b_desc']; ?></textarea>
       </td>
       <td><input type="hidden" name="id" value="<?php echo $arr['b_id']; ?>"></td>
      </tr>
      <tr>
       <td>
