<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\attrvalue\attrvalue.html";i:1514977981;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>属性列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('attrvalue/add'); ?>" class="actionBtn add">添加属性值</a>属性值列表<a href="<?php echo url('attr/index'); ?>" class="actionBtn">属性列表</a></h3>
    <div class="filter">
    </div>
        <div id="list">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        <th width="150" align="center">商品属性名称</th>
        <th width="150" align="center">商品属性值分类</th>
        <th width="150" align="center">操作</th>
      </tr>
      <?php foreach($arr as $k => $v): ?>
      <tr>
        <td align="center"><?php echo $v['attr_name']; ?></td>
        <td align="center"><?php echo $v['attra_val']; ?></td>
        <td align="center">
            <a href="update?id=<?php echo $v['av_id']; ?>">编辑</a> | <a href="delete?id=<?php echo $v['av_id']; ?>">删除</a>
        </td> 
      </tr>
      <?php endforeach; ?>
          </table>
