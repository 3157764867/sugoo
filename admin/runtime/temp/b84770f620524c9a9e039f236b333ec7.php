<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\attrvalue\add_attrvalue.html";i:1514978987;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加属性</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="<?php echo url('attrvalue/attrvalueAdd'); ?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">属性值名称</td>
       <td>
        <input type="text" name="attra_val" value="" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
