<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\show\add_img.html";i:1515046644;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加幻灯广告</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo url('index/show/index'); ?>" class="actionBtn">幻灯广告列表</a>添加幻灯广告</h3>
    <form action="<?php echo url('index/show/add_show'); ?>" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">幻灯名称</td>
       <td>
        <input type="text" name="show_name" id="pay_name" size="80" class="inpMain" />
      ...
      <tr>
       ...
       <td>
        <input type="text" name="show_link"  size="80" class="inpMain" />
        <span id="error" style="color: red;"></span>
       </td>
      </tr>
       <td></td>
