<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\user\user.html";i:1514862121;}*/ ?>
...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="__IMG__coin02.png" /><span><a href="">首页</a>&nbsp;-&nbsp;-</span>&nbsp;管理员管理
			</div>
		</div>
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
					<form action="<?php echo url('index/user/useradd'); ?>" method="post">
						<div class="cfD">
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="40px">
							...
							<td><a href="userupdate.html"><img class="operation"
