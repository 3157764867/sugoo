<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\category\category_set.html";i:1514960854;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="<?php echo url('category/cateSave'); ?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right">分类名称</td>
       <td>
        <input type="text" name="c_name" value="<?php echo $data['c_name']; ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
        <td><input type="hidden" name="id" value="<?php echo $data['c_id']; ?>"></td>
       <td>
