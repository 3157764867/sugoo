<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\goods\goods_sku.html";i:1515065409;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>商品sku列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3>商品sku列表</h3>
    
        <div id="list">
    <form name="action" method="post" action="<?php echo url('goods/sku'); ?>">
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        <th align="center">sku规格</th>
        <th align="center">商品价格</th>
        <th align="center">商品原价</th>
      ...
      <tbody>
        <?php foreach($sku as $k => $v): ?>
            <tr id="<?php echo $k; ?>">
              <input type="hidden" name="sku[<?php echo $k; ?>][g_id]" value="<?php echo $g_id; ?>">
        <td align="center"><?php echo $v; ?><input type="hidden" name="sku[<?php echo $k; ?>][sku]" value="<?php echo $v; ?>" class="inpMain"></td>
        <td align="center"><input type="text" name="sku[<?php echo $k; ?>][g_price]" class="inpMain"></td>
        <td align="center"><input type="text" name="sku[<?php echo $k; ?>][mark_price]" class="inpMain"></td>
        <td align="center"><input type="text" name="sku[<?php echo $k; ?>][sku_num]" class="inpMain"></td>
        <td align="center" id="del" delete="<?php echo $k; ?>">删除</td>
      </tr>
      <?php endforeach; ?>
      </tbody>  
          </table>
