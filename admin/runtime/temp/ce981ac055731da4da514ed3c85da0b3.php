<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\category\category.html";i:1514862121;}*/ ?>
...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="<?php echo url('index/category/categoryadd'); ?>">上传广告&nbsp;&nbsp;+</a>
				</div>
				<!-- banner 表格 显示 -->
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>1</td>
							<td><div class="bsImg">
									<img src="__IMG__banimg.png">
								</div></td>
							<td>双十一连天购</td>
							<td><a class="bsA" href="#">http://www.sdfsdfsdfds.com</a></td>
							<td>是</td>
							<td>1</td>
							<td><a href="<?php echo url('index/category/categoryupdate'); ?>"><img class="operation"
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="__IMG__shanchu.png" /></a>
			</div>
