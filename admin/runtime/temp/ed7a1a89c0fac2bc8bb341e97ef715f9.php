<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\attr\attr.html";i:1514975939;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>属性列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo url('attr/add'); ?>" class="actionBtn add">添加属性</a>属性列表<a href="<?php echo url('attrvalue/index'); ?>" class="actionBtn">属性值列表</a></h3>
    <div class="filter">
    </div>
        <div id="list">
