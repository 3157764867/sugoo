<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\brand\brand.html";i:1515586552;}*/ ?>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>品牌列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th align="80">品牌名称</th>
        <th width="150" align="center">品牌logo</th>
        <th width="150" align="center">品牌描述</th>
        <th width="80" align="center">操作</th>
      </tr>
      <?php foreach($arr as $k => $v): ?>
        <tr>
        <td align="center"><?php echo $v['b_id']; ?></td>
        <td align="center"><?php echo $v['b_name']; ?></td>
        <td align="center"><img src="<?php echo $v['b_logo']; ?>" width="50px" height="50px"></td>
        <td align="center"><?php echo $v['b_desc']; ?></td>
        <td align="center">
            <a href="update?id=<?php echo $v['b_id']; ?>">编辑</a> | <a href="delete?id=<?php echo $v['b_id']; ?>">删除</a>
        </td>
      </tr>
      <?php endforeach; ?>
    </table>
