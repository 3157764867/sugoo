<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\image\image_add.html";i:1515565774;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>商品图片</strong> </div>   <div class="mainBox imgModule">
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
    <tr>
        <h3><a href="<?php echo url('index/image/index'); ?>" class="actionBtn add">添加列表</a>添加图片</h3>
     </tr>
     <tr>
      <td width="350" valign="top">
       <form action="<?php echo url('image/upload'); ?>" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         
         <tr>
          <td><b>图片</b>
           <input type="file" name="photo_url" class="inpFlie" /></td>
         </tr>
         <tr>
          <td><b>图片类型</b>
          <input type="radio" name="photo_type" value="0" size="20"/>商品logo
          <input type="radio" name="photo_type" value="1" size="20"/>商品轮播图
          <input type="radio" name="photo_type" value="2" size="20"/>商品详情图
          </td>
         </tr>
         <tr>
          <td>
