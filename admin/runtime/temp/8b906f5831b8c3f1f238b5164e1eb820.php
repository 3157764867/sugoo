<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\sugoo\admin\public/../application/index\view\image\image_set.html";i:1515137143;}*/ ?>
    ...
    <tr>
     ...
     <tr>
      <td width="350" valign="top">
       <form action="<?php echo url('image/imageSave'); ?>" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         
         <tr>
          <td><b>图片</b>
           <input type="file" name="photo_url" class="inpFlie" value="" /></td>
         </tr>
         <tr>
          <td><b>图片类型</b>
         ...
         <tr>
          <td>
            <input type="hidden" name="id" value="<?php echo $arr['photo_id']; ?>">
