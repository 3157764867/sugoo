...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="/YH/laravel/public/index"><img src="images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
...
<div class="i_bg bg_color">
    <!--Begin 用户中心 Begin -->
    <div class="m_content">
        <?php echo $__env->make('layout.user_left', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
