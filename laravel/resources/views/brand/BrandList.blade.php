...
<div class="i_bg">
	<div class="postion">
        @foreach($res as $k => $v)
    	<span class="fl">全部品牌 > {{$v->b_name}} </span>
        @endforeach
    </div>
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    @foreach($res as $k => $v)
                	<li>
                    	<div class="img"><a href="/goods/{{$v->g_id}}"><img src="{{$v->photo_url}}" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span>{{$v->g_price}}</span></font>
                        </div>
                        <div class="name"><a href="/goods/{{$v->g_id}}">{{$v->goods_name}}</a></div>
                        <div class="carbg">
