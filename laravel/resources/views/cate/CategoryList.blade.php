            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                	...
                	<li>
                    	...
                    	<div class="img"><a href="/goods/<?php echo $v['g_id']?>"><img src="<?php echo $v['photo_url']?>" width="210" height="185" /></a></div>
                        <?php endif;?>
                        <div class="price">
                            <font>￥<span><?php echo $v['g_price']?></span></font>
                        </div>
                        <div class="name"><a href="/goods/<?php echo $v['g_id']?>"><?php echo $v['goods_name']?></a></div>
                        <div class="carbg">
